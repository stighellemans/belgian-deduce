...
_FORBIDDEN_KEYWORDS_PATTERN = re.compile(
    ...
    r"COMITE|COMMISSION|COMMISSIE|CONSEIL|CONTROL|DIENST|EUROPA|EUROPEAN|"
    r"FOD|GEMEENSCHAPSCOMMISSIE|GOUVERNEMENT|KAMER|MINISTER\w*|NAVO|"
    r"OPTIRETOUR|PARLEMENT|POSTCHEQUE|PRESS|PROMO|RADIO|REMAILING|RETOUR|"
    r"RIJKSADMINISTRATIEF|RTBF|SCANNING|SECURITY|SENAAT|SINTERKLAAS|"
    r"SOCIALE|TVI|VLAAMS|VRT)\b"
)
