...
- Removed the GitHub install fallback from the published README now that
  `belgian-deduce` is available on PyPI.
- Fixed the release workflow and lock file so PyPI publishing and release CI run
  successfully from tags.
